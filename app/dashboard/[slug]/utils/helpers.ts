...
export function getWilayahInfo(slug: string) {
  const wilayahMap: Record<
    string,
    { nama: string; type: string; displayName: string }
  > = {
    "kab-bandung": {
      nama: "Kab. Bandung",
      type: "kabupaten",
      displayName: "Kabupaten Bandung",
    },
    "kab-bandung-barat": {
      nama: "Kab. Bandung Barat",
      type: "kabupaten",
      displayName: "Kabupaten Bandung Barat",
    },
    "kab-bekasi": {
      nama: "Kab. Bekasi",
      type: "kabupaten",
      displayName: "Kabupaten Bekasi",
    },
    "kab-bogor": {
      nama: "Kab. Bogor",
      type: "kabupaten",
      displayName: "Kabupaten Bogor",
    },
    "kab-ciamis": {
      nama: "Kab. Ciamis",
      type: "kabupaten",
      displayName: "Kabupaten Ciamis",
    },
    "kab-cianjur": {
      nama: "Kab. Cianjur",
      type: "kabupaten",
      displayName: "Kabupaten Cianjur",
    },
    "kab-cirebon": {
      nama: "Kab. Cirebon",
      type: "kabupaten",
    ...
    "kab-garut": {
      nama: "Kab. Garut",
      type: "kabupaten",
      displayName: "Kabupaten Garut",
    },
    "kab-indramayu": {
      nama: "Kab. Indramayu",
      type: "kabupaten",
      displayName: "Kabupaten Indramayu",
    },
    "kab-karawang": {
      nama: "Kab. Karawang",
      type: "kabupaten",
      displayName: "Kabupaten Karawang",
    },
    "kab-kuningan": {
      nama: "Kab. Kuningan",
      type: "kabupaten",
      displayName: "Kabupaten Kuningan",
    },
    "kab-majalengka": {
      nama: "Kab. Majalengka",
      type: "kabupaten",
      displayName: "Kabupaten Majalengka",
    },
    "kab-pangandaran": {
      nama: "Kab. Pangandaran",
      type: "kabupaten",
      displayName: "Kabupaten Pangandaran",
    },
    "kab-purwakarta": {
      nama: "Kab. Purwakarta",
      type: "kabupaten",
      displayName: "Kabupaten Purwakarta",
    },
    "kab-subang": {
      nama: "Kab. Subang",
      type: "kabupaten",
      displayName: "Kabupaten Subang",
    },
    "kab-sukabumi": {
      nama: "Kab. Sukabumi",
      type: "kabupaten",
      displayName: "Kabupaten Sukabumi",
    },
    "kab-sumedang": {
      nama: "Kab. Sumedang",
      type: "kabupaten",
      displayName: "Kabupaten Sumedang",
    },
    "kab-tasikmalaya": {
      nama: "Kab. Tasikmalaya",
      type: "kabupaten",
      displayName: "Kabupaten Tasikmalaya",
    },
    "kota-bandung": {
      nama: "Kota Bandung",
      type: "kota",
    ...
    "kota-bogor": {
      nama: "Kota Bogor",
      type: "kota",
      displayName: "Kota Bogor",
    },
    "kota-cimahi": {
      nama: "Kota Cimahi",
      type: "kota",
      displayName: "Kota Cimahi",
    },
    "kota-cirebon": {
      nama: "Kota Cirebon",
      type: "kota",
      displayName: "Kota Cirebon",
    },
    "kota-depok": {
      nama: "Kota Depok",
      type: "kota",
      displayName: "Kota Depok",
    },
    "kota-sukabumi": {
      nama: "Kota Sukabumi",
      type: "kota",
      displayName: "Kota Sukabumi",
    },
    "kota-tasikmalaya": {
      nama: "Kota Tasikmalaya",
      type: "kota",
      displayName: "Kota Tasikmalaya",
    },
  };
...
export function capaianStatusFn(nilai: number | null | undefined): string {
  ...
  return nilai >= 80
    ...
    : "Belum Meningkat Sesuai Standar";
}
...
export function getLabelDistPerIndikator(
  satdikTren: { total: number; data: SatdikTrenRow[] } | null,
): Record<
  string,
  {
    baik: SatdikTrenRow[];
    sedang: SatdikTrenRow[];
    kurang: SatdikTrenRow[];
    total: number;
  }
> {
  ...
  const indikatorKeys = Array.from(
    new Set(
      rows.flatMap((r) => Object.keys(r).filter((k) => /^[A-Z]\.\d+/.test(k))),
    ),
  ).sort();
...
export function getTrenDistPerIndikator(
  satdikTren: { total: number; data: SatdikTrenRow[] } | null,
): Record<
  string,
  {
...
export function getValueBgColorClass(
  value: number | null | undefined,
  thresholds?: { good: number; bad: number },
): string {
...
export function getSPMStatusLabel(value: number | null | undefined): {
  label: string;
  color: string;
} {
  if (value == null)
  ...
  if (value >= 80)
    return {
      label: "Meningkat Sesuai Standar",
      color: "bg-emerald-500 text-white",
    };
  return {
    label: "Belum Meningkat Sesuai Standar",
...
// Helper function to remove code from the beginning of a name
export function getCleanIndicatorName(nama: string, kode?: string): string {
  if (!nama) return "-";

  let cleanedName = nama;
  ...
  cleanedName = cleanedName.replace(/^[A-Z]\.\d+(\.\d+)?\s*/, "");
