          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-100">
                <th className="text-left py-3 px-3 text-xs font-bold text-slate-500 align-bottom">NPSN</th>
                <th className="text-left py-3 px-3 text-xs font-bold text-slate-500 align-bottom">Nama</th>
                <th className="text-left py-3 px-3 text-xs font-bold text-slate-500 align-bottom">Jenis</th>
