...
function getWilayahInfo(slug: string) {
...
function Sidebar({ active, setActive, open, setOpen, tahun, wilayahNama }: {
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Dasmen &amp; Vokasi — Tahun {tahun}</p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">{data.tahun || "Kab. Bandung"} — Tahun {tahun} · Nilai SPM &gt; 80 = Meningkat Sesuai Standar</p>
      </div>
...
function KabBandungDashboard() {
      ...
      <div className="flex h-screen items-center justify-center bg-slate-50">
        <div className="text-center">
          ...
          <a href="/pilih-wilayah" className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
            <ArrowLeft size={16} /> Kembali ke Pilih Wilayah
          </a>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex h-screen bg-slate-50 font-sans overflow-hidden">
      <Sidebar active={active} setActive={setActive} open={sidebarOpen} setOpen={setSidebarOpen} tahun={tahun} wilayahNama={wilayahInfo.displayName} />
