        ...
        <div className="px-5 py-5 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/50 text-xs">Kab. Bekasi</p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
      <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-5 text-white shadow-lg">
        ...
        <p className="text-blue-200 text-xs mt-2">Indeks SPM Kab. Bekasi</p>
      </div>
      <div className="bg-gradient-to-br from-violet-600 to-violet-700 rounded-2xl p-5 text-white shadow-lg">
        ...
        <p className="text-violet-200 text-xs mt-2">Indeks SPM Kab. Bekasi</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">Kab. Bekasi — Tahun {tahun}</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">Kab. Bekasi — Analisis perubahan antar tahun</p>
      </div>
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Dasmen &amp; Vokasi — Kab. Bekasi {tahun}</p>
        </div>
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Pendidikan Anak Usia Dini — Kab. Bekasi {tahun}</p>
        </div>
        <div className="flex flex-wrap gap-2">
          {filterKecamatan !== "Semua" && <span className="inline-flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-semibold">📍{filterKecamatan}<button onClick={() => setFilterKecamatan("Semua")} className="ml-1 hover:text-blue-900 font-bold">✕</button></span>}
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="bg-white border-b border-slate-100 px-4 sm:px-5 py-3 flex items-center gap-3 shadow-sm flex-shrink-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-slate-400 hidden sm:block">Rapor Pendidikan Kab. Bekasi</p>
          </div>
