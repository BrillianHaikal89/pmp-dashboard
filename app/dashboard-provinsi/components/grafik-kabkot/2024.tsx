...
export default function GrafikKabkot2024(props: any) {
  ...
  useEffect(() => {
    setLoading(true);
    setError(null);
    fetch("/dataProvinsi/2024/indikator_prioritas.json")
      .then((r) => {
      ...
      <div className="px-6 py-5 bg-gradient-to-br from-slate-50 to-white border-b border-slate-100">
        ...
        <div className="flex gap-3">
          <button
            onClick={handleApply}
            disabled={loading}
            className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-amber-500 to-orange-600 text-white text-xs font-bold rounded-xl hover:from-amber-600 hover:to-orange-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm shadow-orange-100"
          >
            <BarChart3 size={13} />
            Tampilkan Grafik
          </button>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 gap-3 text-slate-400">
            ...
            <p className="text-sm font-semibold text-slate-500">
              ...
              <span className="text-amber-600 font-bold">Tampilkan Grafik</span>
            </p>
